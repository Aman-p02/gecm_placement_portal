...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($enrollmentNo) || empty($password)) {
        ...
        $stmt = $pdo->prepare("SELECT student_id, enrollment_no, password FROM tbl_students WHERE enrollment_no = ?");
...
<body>
    <div class="container auth-container">
        <div class="custom-card">
            <h2 class="text-center mb-4 brand-text">GEC <span>Placement</span></h2>
            ...
            <form action="login.php" method="POST">
                ...
                <div class="mt-3 text-center">
                    <span class="text-muted">Don't have an account?</span> <a href="signup.php" style="color: var(--accent-coral);">Create one</a>
                </div>
            </form>
        </div>
    </div>
